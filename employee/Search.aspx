<%@ Page Language="VB" AutoEventWireup="false" CodeFile="search.aspx.vb" Inherits="employer_ViewAllProjects" %>
...
<head id="Head1" runat="server">
    <meta charset="utf-8"/>
		<title>Project | Project Management System</title>
...
<!--==============================Content=================================-->
		...
		<div class="gray_block gb1">
			...
			<div class="clear">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs_PMS %>" SelectCommand="SELECT [ProjectId], [ProjectName] FROM [Project] ORDER BY [ProjectId]"></asp:SqlDataSource>
