<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Search.aspx.vb" Inherits="employee_Search" %>
...
<head id="Head1" runat="server">
    <meta charset="utf-8"/>
		<title>Search | Project Management System</title>
			...
			<div class="container_12">
				<div class="grid_12">
                    ...
                    <div class="text1 col2">
                        <br /><br />
                        <p><asp:TextBox ID="TBSearch" runat="server" CssClass="searchbox"></asp:TextBox></p>
				    </div>
