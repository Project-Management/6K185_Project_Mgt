<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddNewEmployee.aspx.vb" Inherits="employer_AddNewEmployee" %>
...
<head id="Head1" runat="server">
    <meta charset="utf-8"/>
		<title>New User | Project Management System</title>
			...
			<div class="container_12">
                ...
                <div id="addInfo">
                    <div class="addInfoBox">
                        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" TitleTextStyle-CssClass="addInfoTitle" LabelStyle-CssClass="addInfoText" CancelButtonType="Link" ContinueButtonType="Link" CreateUserButtonType="Link" FinishCompleteButtonType="Link" FinishPreviousButtonType="Link" StepNextButtonType="Link" StepPreviousButtonType="Link">
                            <ContinueButtonStyle CssClass="btn" />
                            <CreateUserButtonStyle CssClass="btn" />
                            <LabelStyle CssClass="addInfoText"></LabelStyle>

                            <TextBoxStyle CssClass="addInfoTextbox" />

                            <TitleTextStyle CssClass="addInfoTitle"></TitleTextStyle>
                            <WizardSteps>
                                <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server" Title="Add a user to the system">
                                </asp:CreateUserWizardStep>
                                <asp:WizardStep ID="UserProfile" runat="server" Title="User Profile Settings">
                                    <br />
                                    <asp:Label ID="lbl_Title" runat="server" Text="User profile settings" CssClass="addInfoTitle"></asp:Label>
                                    <br /><br />
                                    <table>
                                        ...
                                        <tr>
                                            <td align="right" class="addInfoText">Social Security Number:</td> <td align="left" class="auto-style3">
                                                <asp:TextBox ID="tb_SSN" runat="server" Columns="50" CssClass="addInfoTextbox"></asp:TextBox>
                            ...
                            <StepNextButtonStyle CssClass="btn" />
